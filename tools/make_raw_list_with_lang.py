...
if __name__ == '__main__':
    ...
    parser.add_argument('--lang', default=None, help='type lang')
    ...
    with open(args.text_file, 'r', encoding='utf8') as fin, \
        ...
        for line in fin:
            ...
            if args.segments is None:
                ...
                wav = wav_table[key]
                line = dict(key=key, wav=wav, lang=args.lang,txt=txt)
            else:
                assert key in segments_table
                wav_key, start, end = segments_table[key]
                wav = wav_table[wav_key]
                line = dict(key=key, wav=wav, txt=txt, lang=args.lang,start=start, end=end)
...
#     args.wav_file="data//imda_100/wav.scp"
#     args.segments= "data//imda_100/segments"
#     args.text_file= "data//imda_100/text"
#     args.output_file="data/imda_100/data.list"
#     wav_table = {}
#     with open(args.wav_file, 'r', encoding='utf8') as fin:
#         for line in fin:
#             arr = line.strip().split()
